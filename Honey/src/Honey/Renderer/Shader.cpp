...
namespace Honey {
	...
	Honey::Ref<Honey::Shader> ShaderLibrary::Load(const std::string& filepath)
	{
	...
	Honey::Ref<Honey::Shader> ShaderLibrary::Load(const std::string& name, const std::string& filepath)
	{
		auto shader = Shader::Create(filepath);
		Add(name, shader);
		return shader;
	...
	Honey::Ref<Honey::Shader> ShaderLibrary::Get(const std::string& name)
	{
