...
HONEY_VULKAN_VERSION = '1.2.170.0'
VULKAN_SDK_EXE_PATH = 'Honey/vendor/VulkanSDK/VulkanSDK.exe'
...
def InstallVulkanPrompt():
	print("Would you like to install Vulkan SDK?")
...
def CheckVulkanSDK():
	if (VULKAN_SDK is None):
		...
		InstallVulkanPrompt()
		return False
	elif (HONEY_VULKAN_VERSION not in VULKAN_SDK):
		print(f"Located Vulkan SDK at {VULKAN_SDK}")
		print(f"You don't have the correct Vulkan SDK version! (Honey requires {HONEY_VULKAN_VERSION})")
		InstallVulkanPrompt()
		return False
...
OutputDirectory = "Honey/vendor/VulkanSDK"
